...
- `persist-save` writes `scripture-outliner.document.v1` after import and after Deeper.
...
- Import or load a sample, mark a range with **Deeper**, reload the tab.
...
- **New** skips the confirm when there are no segments. After Deeper, the confirm appears.
